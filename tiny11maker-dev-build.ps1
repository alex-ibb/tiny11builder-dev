...
Write-Host "Additional services disabled (Fax, RemoteRegistry, Geolocation, RetailDemo, Diagnostics)!"
...
# First ensure parent key exists (UsrClass.dat stores HKCU\Software\Classes)
& 'reg' 'add' 'HKLM\zUSRCLASS\CLSID\{86ca1aa0-34aa-4e8b-a509-50c905bae2a2}' '/f' | Out-Null
